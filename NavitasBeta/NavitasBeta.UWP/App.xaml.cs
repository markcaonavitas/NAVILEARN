...
namespace NavitasBeta.UWP
{
    ...
    sealed partial class App : Windows.UI.Xaml.Application
    {
        ...
        public App()
        {
            ...
            DependencyService.Register<ParseManager.IParseClientManager, ParseManager.UWP.ParseClientManager>();
            OxyPlot.Xamarin.Forms.Platform.UWP.PlotViewRenderer.Init();
            new Syncfusion.SfGauge.XForms.UWP.SfLinearGaugeRenderer();
        }
