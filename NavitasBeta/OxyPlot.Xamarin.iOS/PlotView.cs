...
namespace OxyPlot.Xamarin.iOS
{
    ...
    public class PlotView : UIView, IPlotView
    {
        ...
        public PlotModel Model
        {
            ...
            set
            {
                System.Diagnostics.Debug.WriteLine("public PlotModel Model");
                if (this.model != value)
                {
                    if (this.model != null)
                    {
                        System.Diagnostics.Debug.WriteLine("((IPlotModel)this.model).AttachPlotView(null)");
                    ...
                    if (value != null)
                    {
                        System.Diagnostics.Debug.WriteLine("((IPlotModel)value).AttachPlotView(this)");
 
                            ((IPlotModel)value).AttachPlotView(this);
  
                        System.Diagnostics.Debug.WriteLine("((IPlotModel)value).AttachPlotView(this) returned");
                        this.model = value;
                    }
                    System.Diagnostics.Debug.WriteLine("this.InvalidatePlot()");
                    this.InvalidatePlot();
                }
            }
        }
        ...
        public PlotModel Model
        {
            ...
            set
            {
           //     System.Diagnostics.Debug.WriteLine("public PlotModel Model this.model = " + model.ToString() + " value = " + value.ToString());
                if (this.model != value)
                {
                    if (this.model != null)
                    {
